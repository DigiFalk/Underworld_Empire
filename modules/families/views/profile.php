...
<div class="dfmg-card">
	...
	<table class="dfmg-table dfmg-table--keyvalue">
		...
		<tr><th><?php esc_html_e( 'Boss', 'wp-maffia-game' ); ?></th><td><?php echo Character::link_by_id( (int) $family['boss_id'] ); // phpcs:ignore ?></td></tr>
		<?php if ( (int) $family['underboss_id'] ) : ?>
			<tr><th><?php esc_html_e( 'Underboss', 'wp-maffia-game' ); ?></th><td><?php echo Character::link_by_id( (int) $family['underboss_id'] ); // phpcs:ignore ?></td></tr>
		<?php endif; ?>
		<tr><th><?php esc_html_e( 'Members', 'wp-maffia-game' ); ?></th><td><?php echo (int) count( $members ) . ' / ' . (int) $cap; ?></td></tr>
		<tr><th><?php esc_html_e( 'Founded', 'wp-maffia-game' ); ?></th><td><?php echo esc_html( Format::date( (int) $family['created_at'] ) ); ?></td></tr>
	</table>
...
<p><a href="<?php echo esc_url( $this->url() ); ?>">&larr; <?php esc_html_e( 'All families', 'wp-maffia-game' ); ?></a></p>
